...
public class DatabaseHelper extends OrmLiteSqliteOpenHelper {
    ...
    private Dao<Movie, Integer> moviesDao = null;
    ...
    public void onCreate(SQLiteDatabase db, ConnectionSource connectionSource) {
        ...
        RuntimeExceptionDao<Movie, Integer> dao = getMovieDataDao();
        long millis = System.currentTimeMillis();
        // create some entries in the onCreate
        Movie simple = new Movie();
        dao.create(simple);
        simple = new Movie();
        dao.create(simple);
     ...
     */
    public RuntimeExceptionDao<Movie, Integer> getMovieDataDao() {
